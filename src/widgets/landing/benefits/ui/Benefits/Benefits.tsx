...
export const Benefits = () => {
  ...
  return (
    <div
      ref={itemRef}
      className="grid grid-cols-12 gap-3 p-4 lg:p-3 bg-white dark:bg-slate-950/50"
    >
      <Link
        to="#"
        style={{ transitionDelay: `${1 * 150}ms` }}
        className="col-span-12 lg:col-span-6 bg-slate-100 dark:bg-slate-900 p-6 lg:px-12 lg:py-16 grid grid-cols-6 rounded-2xl lg:rounded-3xl flex-col lg:gap-12 anim-fade-up"
      >
      ...
      <Link
        ...
        className="col-span-12 lg:col-span-6 bg-stone-100 dark:bg-slate-900 p-6 lg:px-12 lg:py-16 grid grid-cols-6 rounded-2xl lg:rounded-3xl flex-col lg:gap-12 anim-fade-up"
      >
        <div className="flex flex-col col-span-6 lg:col-span-4 gap-6 lg:gap-12 lg:col-start-2 text-lg lg:text-2xl font-semibold text-center dark:text-white">
