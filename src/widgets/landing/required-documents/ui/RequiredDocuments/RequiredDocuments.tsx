  ...
  return (
    ...
    <div className="flex flex-col gap-12 container mx-auto px-6 py-28">
      <div className="grid grid-cols-12 gap-12">
        <div ref={headerRef} className="col-span-8 col-start-3 text-center flex flex-col gap-6 anim-fade-up">
        ...
        <div ref={itemRef} className="col-span-12 grid grid-cols-12 gap-6">
          {REQUIRED_DOCUMENTS.map((document, index) => (
            <div style={{ transitionDelay: `${index * 150}ms` }} key={document.id} className="col-span-4 anim-fade-up">
