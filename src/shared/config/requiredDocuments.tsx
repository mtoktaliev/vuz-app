...
export const REQUIRED_DOCUMENTS: IRequiredDocument[] = [
  {
    ...
    color:
      "text-white bg-linear-to-b from-olive-800 to-olive-950 p-2 lg:p-3 rounded-lg lg:rounded-xl w-fit border-2 border-olive-900 text-2xl lg:text-3xl",
    description:
  ...
  },
  {
    ...
    color:
      "text-white bg-linear-to-b from-fuchsia-800 to-fuchsia-950 p-2 lg:p-3 rounded-lg lg:rounded-xl w-fit border-2 border-fuchsia-900 text-2xl lg:text-3xl",
    description:
  ...
  },
  {
    ...
    name: "Сертификат ОРТ",
    color:
      "text-white bg-linear-to-b from-rose-800 to-rose-950 p-2 lg:p-3 rounded-lg lg:rounded-xl w-fit border-2 border-rose-900 text-2xl lg:text-3xl",
    description:
