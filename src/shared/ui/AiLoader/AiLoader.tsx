...
import magicWand from "../../assets/magicWand.gif";
...
export const SparklesText: React.FC<SparklesTextProps> = ({
  children,
  colors = { first: "#8D22DF", second: "#FAC53A" },
  className,
  sparklesCount = 10,
  ...props
}) => {
  ...
  return (
    <div
      className={cn("animate-pulse text-slate-500", className)}
      {...props}
      style={
        {
...
export const AiLoader = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8 py-20">
      <SparklesText>
        {" "}
        <img src={magicWand} alt="AI Loader" className="w-24 h-24" />{" "}
      </SparklesText>
